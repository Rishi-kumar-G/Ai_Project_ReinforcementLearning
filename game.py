...
bird_image = pygame.image.load(resource_path('assets/bluebird-upflap.png'))
bird_image = pygame.transform.scale(bird_image, (BIRD_WIDTH, BIRD_HEIGHT))
pipe_image = pygame.image.load(resource_path('assets/pipe-green.png'))
pipe_image = pygame.transform.scale(pipe_image, (PIPE_WIDHT, PIPE_HEIGHT))
ground_image = pygame.image.load(resource_path('assets/base.png'))
ground_image = pygame.transform.scale(ground_image, (GROUND_WIDHT, GROUND_HEIGHT))
BACKGROUND = pygame.image.load(resource_path('assets/background-day.png'))
...
class Game:
    ...
    def __init__(self, agent_name, device):
        ...
        if agent_name == "dqn_agent": 
            ...
            self.agent.load("flappy_bird_model.pth")
        self.device = device
    ...
    def train_agent(self, draw, episodes, batches, hyperparameter):
        ...
        self.agent.save("flappy_bird_model.pth")
